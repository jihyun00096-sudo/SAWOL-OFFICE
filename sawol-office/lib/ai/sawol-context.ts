...
export function buildSawolSystemPrompt(context: SawolAiContext) {
  const employeeName =
    firstText(context.employee, ["name", "display_name"]) || "미배정 AI 직원";
  ...
  const departmentName =
    firstText(context.department, ["name", "department_name"]) || "미배정 부서";
